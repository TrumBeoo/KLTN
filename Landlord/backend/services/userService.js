  ...
  async findOrCreateGoogleUser({ googleId, email, name, avatarURL }) {
    ...
    try {
      ...
      await connection.query(
        ...
        [accountId, username, '', 'Landlord', 'Active', googleId, avatarURL]
      );
      ...
      await connection.query(
        'INSERT INTO LANDLORD (LandlordID, AccountID, Username, Name, Email, CreatedAt, UpdatedAt) VALUES (?, ?, ?, ?, ?, ?, ?)',
        [landlordId, accountId, username, name, email, now, now]
      );
